...
if (isset($_POST['submit'])) {
    ...
    mysqli_query($db, "UPDATE  department set department_name ='$name',status='$status' WHERE department_id='"  . $d . "'");
    $stat = 1;
    $re = base64_encode($stat);
    echo ("<SCRIPT LANGUAGE='JavaScript'>
    window.location.href='manage-department.php?status=$re';
    </SCRIPT>");
}

$result = mysqli_query($db, "SELECT * FROM  department WHERE department_id='"  . $d . "'");
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Edit Department
                                </h5>
                            </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">Status*
                                               ...
                                               <select id="" name="status" class="form-control" required>
                                                    <option value="<?php echo $row['2']; ?>">
                                                        <?php if($row['2']==1) { echo Enable;  } else {echo Disable;}?>
                                                    </option>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            ...
                                            <button type="submit" class="btn btn-secondary" name="submit" id="submit">
                                                <i class="feather icon-save"></i>&nbsp; Update Department
                                            </button>
                                        </div>
                                    </div>
                                </div>
