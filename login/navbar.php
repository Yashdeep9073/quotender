    ...
    <div class="navbar-wrapper  ">
        <div class="navbar-content scroll-div ">
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item">
                    <a href="dashboard.php" class="nav-link " style="background:#33cc33; color:#fff;"><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="">Dashboard</span></a>
                </li>

                <?php if ((in_array('Add Section', $permissions)) || (in_array('Manage Section', $permissions)) || (in_array('Add Division', $permissions))
                ...
                ?>
                    <li class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file"></i></span><span class="pcoded-mtext">Section</span></a>
                ...
                <?php if ((in_array('Add Category', $permissions)) || (in_array('Manage Category', $permissions))
                    || (in_array('All', $permissions))
                ) {
                ?>
                    <li class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-edit"></i></span><span class="pcoded-mtext">Category</span></a>
                        <ul class="pcoded-submenu">
                ...
                <?php if ((in_array('Add Brands', $permissions)) || (in_array('Manage Brands', $permissions))
                    || (in_array('All', $permissions))
                ) {
                ?>
                    <li class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file"></i></span><span class="pcoded-mtext">Brands</span></a>
                        <ul class="pcoded-submenu">
                ...
                <?php if ((in_array('Add Departments', $permissions)) || (in_array('Manage Departments', $permissions))
                    || (in_array('All', $permissions))
                ) {
                ?>
                    <li class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Departments</span></a>
                        <ul class="pcoded-submenu">
                ...
                <?php if ((in_array('Add Price List', $permissions)) || (in_array('Manage Price List', $permissions))
                    || (in_array('All', $permissions))
                ) {
                ?>
                <li class="nav-item pcoded-hasmenu">
                    <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-credit-card"></i></span><span class="pcoded-mtext">Price
                            List</span></a>
                    <ul class="pcoded-submenu">
                ...
                <?php if ((in_array('Add Staff User', $permissions)) || (in_array('Manage Staff User', $permissions))
                    || (in_array('All', $permissions))
                ) {
                ?>
                <li class="nav-item pcoded-hasmenu">
                    <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-users"></i></span><span class="pcoded-mtext">Staff User</span></a>
                    <ul class="pcoded-submenu">
                ...
                <?php if ((in_array('Tender Request', $permissions)) || (in_array('Sent Tender', $permissions))
                    || (in_array('Alot Tender', $permissions)) || (in_array('Award Tender', $permissions))
                    || (in_array('All', $permissions))
                ) {
                ?>
                <li class="nav-item pcoded-hasmenu">
                    <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-briefcase"></i></span><span class="pcoded-mtext">Tenders
                        </span></a>
                    <ul class="pcoded-submenu">
                    <?php if ((in_array('Tender Request', $permissions)) || (in_array('All', $permissions))) {
                ...
                ?>
                <li class="nav-item pcoded-hasmenu">
                    <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-credit-card"></i></span><span class="pcoded-mtext">Website
                        </span></a>
                    <ul class="pcoded-submenu">
                ...
                <?php if ((in_array('Setting', $permissions))|| (in_array('All', $permissions))
                ) {
                ?>
                <li class="nav-item">
                    <a href="configuration.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-server"></i></span><span class="">Setting</span></a>
                </li>
                <?php } ?>

                <?php if ((in_array('Email Services', $permissions))|| (in_array('All', $permissions))
                ) {
                ?>
                <li class="nav-item">
                    <a href="email-services.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-server"></i></span><span class="">Email Services</span></a>
                </li>
                <?php } ?>

                <li class="nav-item">
                    <a href="changepass.php" class="nav-link"><span class="pcoded-micon"><i class="feather icon-command"></i></span><span class="">Change
                            Password</span></a>
                </li>

                <?php if ((in_array('Logs Report', $permissions))|| (in_array('All', $permissions))
                ) {
                ?>
                <li class="nav-item">
                    <a href="reports.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-plus"></i></span><span class="">Logs Report</span></a>
                </li>
                <?php } ?>

                <li class="nav-item">
                    <a href="logout.php" class="nav-link " style="background:#33cc33; color:#fff;"><span class="pcoded-micon"><i class="feather icon-power"></i></span><span class="">Log
                            out</span></a>
                </li>
