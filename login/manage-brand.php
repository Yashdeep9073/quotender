...
<body class="">
  ...
  <strong><i class='feather icon-check'></i>Thanks!</strong>Brand  has been Updated Successfully.
  ...
  <strong>Error!</strong> Brand has not Updated
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
  </button>
</div> ";
