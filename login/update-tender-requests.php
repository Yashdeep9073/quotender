    ...
    // } else {
        ...
        // if ($file_size < 3 * 1024 * 1024) {
            ...
            foreach ($tenderIds as $updateTenderId) {
                ...
                // Delete the old file
                $query = "SELECT user_tender_requests.file_name  FROM user_tender_requests WHERE id='"  . $updateTenderId . "'";
            ...
            if ($autoEmailResponse3 == '1' and $continueWithMail = true) {
                ...
                inner join members m on ur.member_id= m.member_id  WHERE ur.id in ($stringTenderIds)";
