                    ...
                    echo '<div class="card">';
                        ...
                        echo '<div class="card-body">';
                            echo '<div class="dt-responsive table-responsive">';
                                ...
                                echo '<table  id="" class="table table-striped table-bordered nowrap">';
                                
                                echo "<thead>";
                                    echo "<tr class='table-success thead-light'>";
                                    echo "<th colspan='12' class='text-center'><h5>Tender ID : <span class='text-danger'>". $tenderID ."</span></h5></th>";
                                    echo "</tr>";
