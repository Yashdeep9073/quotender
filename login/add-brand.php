...
if (isset($_POST['submit'])) {
    ...
    if (!in_array($file_type, $allowed_types)) {
        ...
        if ($file_size < 2 * 1024 * 1024) {
            ...
            $query = "insert into brand (brand_name,brand_image) values('$brand','$unique_filename')";
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> Brand Name
                                                ...
                                                <input name="brand" type="text" placeholder=" Enter the Brand Name"
                                                    class="form-control input-md" required
                                                    oninvalid="this.setCustomValidity('Please Enter Brand Name')"
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            ...
                                            <button type="submit" class="btn btn-secondary" name="submit" id="submit">
                                                <i class="feather icon-save"></i>&nbsp; Add Brand
                                            </button>
                                        </div>
                                    </div>
                                </div>
