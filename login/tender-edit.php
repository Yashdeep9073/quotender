...
if (isset($_POST['submit'])) {
    ...
    if($fileUploaded1 == true || $fileUploaded2 == true){
            ...
            // Delete the old file
            $query = "SELECT user_tender_requests.file_name , user_tender_requests.file_name2  FROM user_tender_requests WHERE id='"  . $d . "'";
            ...
            `file_name`='$unique_filename1',`file_name2`='$unique_filename2',`status`='Sent', `sent_at`='$sent_at' , `auto_quotation`='$autoEmail' WHERE `id`='"  . $d . "'");
