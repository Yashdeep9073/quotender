        ...
        if ($pening_requests[0] > 0) {
            ...
            if (mysqli_num_rows($tenderExistsResult) == 0) {
                ...
                $mail->Body =  "<p> Dear " . $memberData[1] . ",<br/> 
                    Thanks for Your valuable Enquiry <br/>
                    We will Revert you soon for the prices with in 3-5 working days for the following Tender. <br/> 
                    <p><b>Firm Name. :-</b> " .  $memberData[2]  . " </p>
                    <p><b>Tender Id. :-</b> " .  $tender  . " </p>
                    <strong>Thanks, <br/>Admin Quote Tender</strong> <br/>
                    Mobile: +91-94176-01244 | Email: info@quotender.in ";
            } else {
